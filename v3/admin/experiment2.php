...
?>
				...
				<h3>Identify whether the given bacteria is sensitive to light</h3>
				...
				<img src='img/bac/2.jpg' />
				<a href='experiment3.php' class="btn btn-primary" >Yes	</a>
				<a href='experiment3.php' class="btn btn-primary" >No	</a>					
				</div>
			</div>
		</div>
	</div>
