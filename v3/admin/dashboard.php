...
?>
  ...
  function resizeIframe(obj) {
    ...
    obj.style.height = obj.contentWindow.document.body.scrollHeight + 'px';
                ...
                <a href="../graphs/sparkline/sparkline.php" target="search_iframe" class="btn btn-primary" >Participant Sparkline Graph</a>
                <a href="../graphs/crossfilter/carnival.php" target="search_iframe" class="btn btn-primary">Learning TimeLine</a>
				...
				<div><iframe src="../graphs/sparkline/sparkline.php" frameborder=0 width="100%" scrolling=no name="search_iframe" id="search_iframe" onload="resizeIframe(this);"></iframe></div>
				</div>
				</div>
			</div>
		</div>
