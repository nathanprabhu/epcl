								...
								<form action="datasubmit.php" method="POST" class='form-horizontal form-wizard' id="bb">
									<div class="step" id="firstStep">
										...
										<div class="form-group">
											...
											<div class="col-sm-10">
												<input type="text" name="anotherelem" id="anotherelem" class="form-control" required>
											</div>
										</div>
										<div class="form-group">
											<label for="additionalfield" class="control-label col-sm-2">Description</label>
											<div class="col-sm-10">
												<input type="text" name="additionalfield" id="additionalfield" class="form-control" required>
											</div>
										</div>
									</div>
									<div class="step" id="secondStep">
										<div class="form-group">
											...
											<div class="col-sm-10">
												<input type="number" min="0" name="additionalfield" id="additionalfield" class="form-control"  required>
											</div>
										</div>
										<div class="form-group">
