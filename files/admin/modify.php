...
?>
				...
				<div class="breadcrumbs">
					<ul>
						...
						<li>
							<a href="modify.php">Modify New Experiment</a>
						</li>
					</ul>
								...
								<form action="datasubmit.php" method="POST" class='form-horizontal form-wizard' id="bb">
									<div class="step" id="firstStep">
										<div class="form-group">
											...
											<div class="col-sm-10">
												<SELECT>
													<option value="">Test-GEN</option>
													<option value="">Test-GEN1</option>
												</SELECT>
											</div>
										</div>
										<div class="form-group">
									...
									<div class="step" id="secondStep">
										<div class="form-group">
											...
											<div class="col-sm-10">
												<input type="number" min="0" name="additionalfield" id="additionalfield" class="form-control">
											</div>
										</div>
										<div class="form-group">
