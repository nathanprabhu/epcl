...
?>
				...
				<form name="change">
					<p></p>
				<p>Select User ID - Graph Type / User Group - Graph Type</p>	
<SELECT NAME="options" ONCHANGE="document.getElementById('youriframe').src = this.options[this.selectedIndex].value">
<option value="">--Select User ID and Graph--</option>	
<option value="../graphs/r1_user_learning_curve/report_user_10001.html">10001 - User Learning Curve</option>
<option value="../graphs/r1_user_learning_curve/report_user_10002.html">10002 - User Learning Curve</option>
<option value="../graphs/r1_user_learning_curve/report_user_10003.html">10003 - User Learning Curve</option>
<option value="../graphs/r3_user_heatmap/user_heatmap_10001.html">10001 - User Heatmap</option>
<option value="../graphs/r3_user_heatmap/user_heatmap_10002.html">10002 - User Heatmap</option>
<option value="../graphs/r3_user_heatmap/user_heatmap_10003.html">10003 - User Heatmap</option>
<option value="">--Select User Group and Graph--</option>	
<option value="../graphs/r2_group_learning_curve/report_group_100xx.html">100xx - Group Learning Curve</option>
<option value="../graphs/r2_group_learning_curve/report_group_200xx.html">200xx - Group Learning Curve</option>
<option value="../graphs/r4_group_heatmap/user_heatmap_100xx.html">100xx - Group Heatmap</option>
<option value="../graphs/r4_group_heatmap/user_heatmap_100xx.html">200xx - Group Heatmap</option>
</SELECT>

				</div>
				<div>
					<iframe name="iframe" id="youriframe" src="http://www.yahoo.com" width=960px height=900 frameborder=0 scroll=no></iframe>
				</div>
