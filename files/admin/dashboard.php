...
?>
				...
				<div>
					<iframe src="../graphs/d1_user_freq/user_freq.html" width=960px height=500 frameborder=0 scroll=no></iframe>
				</div>
				<div>
					<iframe src="../graphs/d2_group_freq/group_freq.html" width=960px height=500 frameborder=0 scroll=no></iframe>
				</div>
				<div>
					<iframe src="../graphs/d3_user_learning_curve/user_learning_curve.html" width=960px height=550 frameborder=0 scroll=no></iframe>
				</div>
				<div>
					<iframe src="../graphs/d4_group_avg_curve/grp_avg_answers.html" width=960px height=500 frameborder=0 scroll=no></iframe>
				</div>
