...
?>
				...
				<h3>Identify whether the given bacteria is sensitive to light and heat</h3>
				...
				<img src='img/bac/8.jpg' />
				<a href='experimentend.php' class="btn btn-primary" >Yes	</a>
				<a href='experimentend.php' class="btn btn-primary" >No	</a>					
				</div>
			</div>
		</div>
	</div>
