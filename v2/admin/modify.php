								...
								<form action="datasubmit.php" method="POST" class='form-horizontal form-wizard' id="bb">
										...
										<div class="form-group">
											...
											<div class="col-sm-10">
												<SELECT name='options1' id='options1'>
													...
													<option value="Test1">Test-GEN1</option>
												</SELECT>
												</div>
										</div>
										<div class="form-group">
											...
											<div class="col-sm-10">
												<input type="text" name="anotherelem1" id="anotherelem1" class="form-control">
											</div>
										</div>
										<div class="form-group">
											<label for="additionalfield" class="control-label col-sm-2">Description</label>
											<div class="col-sm-10">
												<input type="text" name="additionalfield1" id="additionalfield1" class="form-control">
											</div>
										</div>
									</div>
									<div class="step" id="secondStep">
										<div class="form-group">
											...
											<div class="col-sm-10">
												<input type="number" min="0" name="additionalfield2" id="additionalfield2" class="form-control">
											</div>
										</div>
										<div class="form-group">
											<label for="additionalfield" class="control-label col-sm-2">No. of Blocks</label>
											<div class="col-sm-10">
												<input type="number" min="0" name="additionalfield3" id="additionalfield3" class="form-control">
											</div>
										</div>
										<div class="form-group">
										...
										<div class="form-group">
											...
											<div class="col-sm-10">
												<div class="checkbox">
													<label>
														<input type="checkbox" name="policy" value="agree">Yes.</label>
												</div>
											</div>
										</div>
									</div>
