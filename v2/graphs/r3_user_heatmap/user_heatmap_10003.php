...
$(function () {
    ...
    $('#container').highcharts({
        ...
        title: {
            text: 'No of +ve and -ve Answers - Participant 10003'
        },
        ...
        tooltip: {
            formatter: function () {
                return '<b> Participant 10003 answered ' + 
                    this.point.value + ' </b> trials <br>' + 'with '+ this.series.yAxis.categories[this.point.y] + ' on '+this.series.xAxis.categories[this.point.x] ;
            }
        },

        series: [{
            name: 'No of +ve and -ve Answers - Participant 10003',
            borderWidth: 1,
            data: [[0, 0, 4], [0, 1, 8], [1, 0, 3], [1, 1, 9], [2, 0, 8], [2, 1, 4], [3, 0, 10], [3, 1, 2], [4, 0, 9], [4, 1, 3], [5, 0, 7], [5, 1, 5],  [6, 0, 3], [6, 1, 9], [7, 0, 4], [7, 1, 8], [8, 0, 9], [8, 1, 3], [9, 0, 4], [9, 1, 8]],
            dataLabels: {
                enabled: true,
                color: '#000000'
            }
